...
const translations = {
  en: {
    ...
    testimonials: {
      ...
      items: [
        { quote: '"Creative Imprints delivered our platform in 6 weeks. The quality rivals anything I\'ve seen out of San Francisco."', name: 'Sara Al-Mutairi', role: 'CEO, Nayabank', avatar: 'S' },
        { quote: '"They didn\'t just build software — they shaped our entire product thinking. A true partner."', name: 'Omar Khalid', role: 'Founder, Luman Health', avatar: 'O' },
        { quote: '"World-class team. Every detail is intentional. Our conversion doubled within a month."', name: 'Hala Ibrahim', role: 'CMO, Atlas Commerce', avatar: 'H' },
      ],
    },
    portfolio: {
      label: 'SELECTED WORK',
      ...
      items: [
        ...
        { title: 'Passenger Transport', subtitle: 'Transport App', category: 'Mobile', gradient: 'from-purple-500 to-pink-600', image: 'portfolio2.jpeg' },
        { title: 'Online Store', subtitle: 'E-commerce site', category: 'Web', gradient: 'from-cyan-500 to-teal-600', image: 'portfolio3.jpeg' },
        { title: 'Educational Platform', subtitle: 'LMS Platform', category: 'Web', gradient: 'from-orange-500 to-red-600', image: 'portfolio4.jpeg' },
        { title: 'Visual Identity', subtitle: 'Brand system', category: 'Branding', gradient: 'from-teal-500 to-cyan-600', image: 'portfolio5.jpeg' },
  ...
  ar: {
    ...
    expertise: {
      ...
      items: [
        { title: 'تطبيقات الجوال', description: 'تطبيقات أصلية ومتعددة المنصات بحركة سينمائية وأداء متين.', icon: '📱' },
        { title: 'منصات الويب', description: 'تجارب ويب فائقة السرعة ومُحسَّنة لمحركات البحث مبنية بأحدث التقنيات.', icon: '🌐' },
        { title: 'التجارة الإلكترونية', description: 'متاجر وأسواق عالية التحويل مصممة خصيصاً لعلامتك التجارية.', icon: '🛒' },
        { title: 'منصات التعلم', description: 'أنظمة إدارة تعلم قابلة للتوسع ومنتجات تعليمية بتجربة مستخدم مبهجة.', icon: '🎓' },
        { title: 'تصميم واجهات وتجربة المستخدم', description: 'أنظمة تصميم وواجهات مدفوعة بالبحث تبدو طبيعية ومقنعة.', icon: '🎨' },
        { title: 'حلول الذكاء الاصطناعي', description: 'وكلاء LLM مخصصون، خطوط RAG، وميزات ذكاء اصطناعي مدمجة في منتجك.', icon: '🤖' },
        { title: 'العلامات التجارية', description: 'أنظمة هوية تحوِّل الاستراتيجية إلى جاذبية بصرية مؤثرة.', icon: '✨' },
        { title: 'الأنظمة السحابية', description: 'بنية تحتية مرنة وآمنة مصممة للتوسع إلى الملايين من المستخدمين.', icon: '☁️' },
        { title: 'التحول الرقمي', description: 'تحديث العمليات التقليدية إلى قوة رقمية قابلة للقياس.', icon: '🚀' },
      ],
    },
    builtDifferent: {
      title: 'مصمم بطريقة مختلفة. مصمم ليدوم.',
      items: [
        { title: 'تقنيات حديثة', description: 'نعمل بأحدث الأطر والتقنيات ونماذج الذكاء الاصطناعي دائماً.', icon: '🧠' },
        { title: 'مهووس بالسرعة', description: 'نطلق المنتجات في أسابيع وليس أرباع السنة — بدون التضحية بالجودة.', icon: '⚡' },
        { title: 'الأمان أولاً', description: 'أمان وامتثال على مستوى المؤسسات مدمج منذ اليوم الأول.', icon: '🛡️' },
        { title: 'قابل للتوسع بلا حدود', description: 'بنيات معمارية خاضعة لاختبارات مكثفة من الـ MVP إلى ملايين المستخدمين.', icon: '📈' },
        { title: 'فريق من الخبراء', description: 'لا مبتدئين يتعلمون على حسابك — فقط متخصصون ذوو خبرة مثبتة.', icon: '👥' },
        { title: 'تجربة مستخدم محبوكة', description: 'عناية فائقة بالبكسل. حركات تسر الناظر. تفاصيل تحقق التحويل.', icon: '🎯' },
      ],
    },
    finalCta: {
    ...
    testimonials: {
      ...
      items: [
        { quote: '"قدمت Creative Imprints منصتنا في 6 أسابيع. الجودة تنافس أي شيء رأيته خارج سان فرانسيسكو."', name: 'سارة المطيري', role: 'الرئيس التنفيذي، نايابنك', avatar: 'س' },
        { quote: '"لم يبنوا مجرد برمجيات — بل شكلوا كامل فكر منتجنا. شريك حقيقي."', name: 'عمر خالد', role: 'المؤسس، لومان هيلث', avatar: 'ع' },
        { quote: '"فريق عالمي. كل التفاصيل مدروسة. تضاعفت التحويلات في شهر واحد."', name: 'هالة إبراهيم', role: 'مديرة التسويق، أطلس كومرس', avatar: 'ه' },
      ],
    },
    portfolio: {
      label: 'أعمال مختارة',
      ...
      items: [
        { title: 'نوفابنك', subtitle: 'منصة تقنية مالية', category: 'ويب', gradient: 'from-blue-500 to-purple-600', image: 'portfolio1.jpeg' },
        { title: 'تطبيق نقل الركاب', subtitle: 'تطبيق مواصلات', category: 'جوال', gradient: 'from-purple-500 to-pink-600', image: 'portfolio2.jpeg' },
        { title: 'متجر إلكتروني', subtitle: 'متجر عبر الإنترنت', category: 'ويب', gradient: 'from-cyan-500 to-teal-600', image: 'portfolio3.jpeg' },
        { title: 'منصة تعليمية', subtitle: 'منصة تعليم إلكتروني', category: 'ويب', gradient: 'from-orange-500 to-red-600', image: 'portfolio4.jpeg' },
        { title: 'الهوية البصرية', subtitle: 'نظام العلامة التجارية', category: 'علامات تجارية', gradient: 'from-teal-500 to-cyan-600', image: 'portfolio5.jpeg' },
        { title: 'بالس ليرن', subtitle: 'منصة تعليمية', category: 'جوال', gradient: 'from-blue-600 to-indigo-700', image: 'portfolio6.jpeg' },
      ],
    },
    footer: {
      brandName: 'كرياتيف إمبرينتس',
